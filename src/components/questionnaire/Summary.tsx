...
import { CheckCircle2, User, Shield, Stethoscope, FileText, RotateCcw, Printer } from "lucide-react";
  ...
  return (
    <div className="w-full max-w-2xl mx-auto animate-slide-up">
      ...
      <div className="bg-card rounded-2xl p-8 shadow-lg space-y-8">
        ...
        {(data.sexo === 'feminino' || data.sexo === 'masculino') && (
          <SummarySection title="Perguntas Específicas" icon={FileText}>
            {data.sexo === 'feminino' && (
              <>
                <SummaryItem 
